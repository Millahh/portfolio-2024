...
const Experiences = () => {
    ...
    return (
        <div className="experiences py-10 px-20 min-w-full h-screen overflow-y-auto">
            <div className="flex flex-row h-2/5 relative">
                ...
                <div className="basis-3/4 p-5 pl-10">
                    ...
                    <p className=" text-xl font-bold text-primary bg-white bg-opacity-90 inline-block px-1 pt-1">Fullstack Developer at PT. Andromedia</p>
            ...
            <div className="flex flex-row h-2/5 relative">
                ...
                <div className="basis-3/4 p-5 pl-10">
                    ...
                    <p className=" text-xl font-bold text-primary bg-white bg-opacity-90 inline-block px-1 pt-1">Expert Staff of Information and Technology <br></br>Development (PIT)</p>
            ...
            <div className="flex flex-row h-2/5 relative">
                ...
                <div className="basis-3/4 p-5 pl-10">
                    <p className=" tracking-widest text-xs opacity-50">ORGANIZATION | 2021</p>
                    <p className=" text-xl font-bold text-primary bg-white bg-opacity-90 inline-block px-1 pt-1">Public Relations Staff of Organization of <br></br>Open Source (POROS)</p>
                </div>
            </div>
            <div className="flex flex-row h-2/5">
                <div className="basis-1/2 p-5 pl-10">
                    <p className=" tracking-widest text-xs opacity-50">HARD SKILLS</p>
            ...
            <div className="flex flex-row relative">
                <div className="basis-3/4 w-screen p-5 pr-10 text-right">
            ...
            <div className="text-center">
                <p className="text-xl font-bold text-primary bg-white bg-opacity-90 inline-block px-1 pt-1">PK2MABA & STARTUP ACADEMY</p>
            ...
            <div className="flex flex-row h-2/5">
                <div className=" basis-auto p-5 pl-10">
                    <img src="./experiences/image.png" className="cover w-11/12 border-2 border-white rounded-xl"/>
                </div>
                <div className="basis-auto p-5 pl-10">
                    <img src="./experiences/image.png" className="cover w-11/12 border-2 border-white rounded-xl"/>
            ...
            <p className=" tracking-widest text-xs opacity-50">SOFT SKILLS</p>
            <p className=" text-base font-bold text-primary bg-white bg-opacity-90 inline-block px-1 pt-1">Staff of Event Division | 2021</p>
            ...
            <li><P>Best staf</P>f and <P>person in charge</P> of a series of Fusion events.</li>

            <p className=" text-base font-bold text-primary bg-white bg-opacity-90 inline-block px-1 pt-1">Staff of Companion Division | 2020</p>
            ...
            <p className=" text-base font-bold text-primary bg-white bg-opacity-90 inline-block px-1 pt-1">Speaker of Program Kreatifitas Mahasiswa Baru (PKM) | 2020</p>
            ...
            <div className="flex flex-row h-2/5">
                ...
                <div className="basis-3/4 p-5 pl-10">
                    <p className=" tracking-widest text-xs opacity-50">VOLUNTEER | 2021</p>
                    <p className=" text-xl font-bold text-primary bg-white bg-opacity-90 inline-block px-1 pt-1">Head of Event Division at LKMM-TD</p>
