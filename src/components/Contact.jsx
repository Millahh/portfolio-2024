...
const Contact = () => {
  ...
  return (
    <motion.div 
      ...
      <p className="bottom-2 right-3 text-sm font-sans italic max-md:hidden max-xs:text-[0.5rem] fixed z-20">The bad news is that the dice may be unpredictable, but the good news is that the dice are in your hand. </p>
    </motion.div>
  );
};
