            ...
            <div className="flex flex-row">
                ...
                <div className=" basis-3/5 py-10 px-10 h-screen overflow-y-auto">
                    ...
                    <div className="inline">
                        <img src={Laravel} width={20} className="inline"/>
                        <img src={Bootstrap} width={20} className="inline"/>
                    </div>
                    ...
                    <div className="inline">
                        <img src={Tailwind} width={20} className="inline"/>
                        <img src={React} width={20} className="inline"/>
                    </div>
                    <p>I’ve recently been interested built front-end web using Tailwind and React. (Tracker, youRnoteS)</p>
                    <img src={Threejs} width={20}/>
                    ...
                    <div className="inline">
                        <img src={PostgreSQL} width={23} className="inline"/>
                        <img src={phpMyAdmin} width={30} className="inline"/>
                    </div>
                    ...
                    <div className="inline">
                        <img src={JavaScript} width={25} className="inline"/>
                        <img src={PHP} width={25} className="inline"/>
                        <img src={Figma} width={20} className="inline"/>
                        <img src={AdminLTE} width={20} className="inline"/>
                        <img src={HTML} width={25} className="inline"/>
                        <img src={CSS} width={25} className="inline"/>
                    </div>
