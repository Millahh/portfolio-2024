...
const About = ({setCurrentPage, setIsStart, isFocused, setFocused}) => {
    return(
        ...
        <motion.div 
            ...
            <p className="max-xs:right-8 bottom-2 right-3 text-sm font-sans italic max-md:hidden fixed z-20 max-xs:text-[0.5rem]">Don&apos;t quit rolling the dice except you win. </p>
        </motion.div>
        </>
    )
}
