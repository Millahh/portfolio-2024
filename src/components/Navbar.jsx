    ...
    return (
        <>
            <div className="navbar flex md:justify-between px-10 pt-5 xl:w-1/2 lg:w-2/3 md:w-full 2xl:m-auto max-md:hidden max-sm:hidden max-xs:hidden">
                <NavLink activeClassName="active" to="/" className="flex hover:scale-125 transition-transform duration-100 opacity-50 hover:opacity-100">HI<p className="text-sm -ml-1">👋</p></NavLink>
                <MyLinks/>
            </div>
            <div class="md:hidden max-w-screen-xl pt-4 pr-4">
                ...
                <div class="navbar w-1/2 max-md:w-1/3 max-md:bg-primary max-md:bg-opacity-10 text-center self-center m-auto max-md:mr-0 pl-4 max-md:pr-10" id="navbar-mobile">
                    <NavLink activeClassName="active" to="/" className="flex m-auto hover:scale-125 justify-center max-md:mr-0 max-md:justify-end transition-transform duration-100 opacity-50 hover:opacity-100 w-20">HI<p className="text-sm -ml-1">👋</p></NavLink>
                    <MyLinks/>
                </div>
                }
            </div>
